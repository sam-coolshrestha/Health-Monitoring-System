...
export default function HealthDashboard() {
  ...
  return (
    <div style={{ fontFamily: "'DM Sans', sans-serif", background: "#030712", minHeight: "100vh", width: "100%", color: "#f3f4f6" }}>
      <style>{`
      ...
      <div style={{ maxWidth: "100%", margin: "0 auto", padding: "24px 24px" }}>
